...
bedrijventerreinen.vlaanderen.be has been setup to minimize the rollout and maintenance effort of any change to the system in a predicatable way. 
The figure below shows the four layers of the environment. 

![The process](update-process.jpg)

The bottom layer is the cloud infrastructure. For bedrijventerreinen.vlaanderen.be this is [Azure](https://azure.microsoft.com/). 
...
Docker swarm is native clustering for Docker. Docker swarm is responsible for executing the services of bedrijventerreinen.vlaanderen.be.
